...
namespace IDEALENS.IVR.Editor
{
	class IVRSDKWindow : EditorWindow
	{
		...
		static void Init()
		{
			...
			IVRSDKWindow window = (IVRSDKWindow)EditorWindow.GetWindowWithRect<IVRSDKWindow>(new Rect{ width = 300,height = 500},true,"Help");
		}
		...
		void OnGUI()
		{
			...
			if (GUILayout.Button("Document", GUILayout.Height(30)))
			{
				Application.OpenURL("https://github.com/IDEALENSGroup/IVRSDK_Unity");
			}
